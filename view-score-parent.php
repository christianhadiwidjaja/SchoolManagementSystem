...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(isset($_POST['searchbyname'])){
        ...
        header("location: view-score-parent.php");
        return;
    }
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            ?>
            <h1>View Score (<?php echo $stuname;?>)</h1>
            <hr>
            ...
            $sql = "SELECT a.id AS id, b.id AS subject_id, a.student_id AS student_id, a.assignment_score AS assignment_score, a.uts_score AS uts_score,
                    a.uas_score AS uas_score, a.project_score AS project_score, b.name AS subject_name, c.name AS student_name
                    FROM `msscore` a
                    LEFT JOIN mssubject b ON a.subject_id = b.id
                    LEFT JOIN msstudent c ON a.student_id = c.id
