...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(isset($_POST['searchbyname'])){
        ...
        header("location: view-classroom.php");
        return;
    }
        ...
        <div class="col-md-10">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" name="f1" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-4">
                        <div class="input-group" style="width:100%;">
                            <input type="text" name="searchNameTxt" class="form-control" placeholder="Search Class Name" value="<?php echo $_SESSION['searchNamePT'];?>">
                        </div>
                    </div>

                    <div class="col-md-1">
                        <div class="input-group" style="width:120%;">
                            <input type="text" name="IDTxt" class="form-control" placeholder="Class Code" value="<?php echo $_SESSION['searchIDMY'];?>">
                        </div>
                    </div>
                </div>
                <p></p>
                <div class="row">
                    ...
                    <div class="col-md-2">
                        Date From:
                        <input type="date" value="<?php echo $_SESSION['reqdatefromfilterviewformccs']; ?>" class="form-control" name="reqdatefrom">
                    </div>

                    <div class="col-md-2">
                        Date To:
                        <input type="date" value="<?php echo $_SESSION['reqdatetofilterviewformccs']; ?>" class="form-control" name="reqdateto">
                    </div>

                    <div class="col-md-2">
                        Status: 
                        <select name="filterstatusform" class="form-select">
                            <option value="" <?php if($_SESSION['statusformfilterviewformccs'] == ""){ echo "selected";} ?>>All</option>
                            <option value="Not Yet Started" <?php if($_SESSION['statusformfilterviewformccs'] == "Not Yet Started"){ echo "selected";} ?>>Not Yet Started</option>
                            <option value="Ongoing" <?php if($_SESSION['statusformfilterviewformccs'] == "Ongoing"){ echo "selected";} ?>>Ongoing</option>
                            <option value="Done" <?php if($_SESSION['statusformfilterviewformccs'] == "Done"){ echo "selected";} ?>>Done</option>
                            <!-- <option value="IN PROGRESS" <?php if($_SESSION['statusformfilterviewformccs'] == "IN PROGRESS"){ echo "selected";} ?>>IN PROGRESS</option> -->
                            <!-- <option value="REJECTED" <?php if($_SESSION['statusformfilterviewformccs'] == "REJECTED"){ echo "selected";} ?>>REJECTED</option> -->
                            <option value="Cancelled" <?php if($_SESSION['statusformfilterviewformccs'] == "Cancelled"){ echo "selected";} ?>>Cancelled</option>
                            <!-- <option value="DONE" <?php if($_SESSION['statusformfilterviewformccs'] == "DONE"){ echo "selected";} ?>>DONE</option> -->
                            <option value="Rescheduled" <?php if($_SESSION['statusformfilterviewformccs'] == "Rescheduled"){ echo "selected";} ?>>Rescheduled</option>
                            <!-- <option value="REPLIED BY CCS" <?php if($_SESSION['statusformfilterviewformccs'] == "REPLIED BY CCS"){ echo "selected";} ?>>REPLIED BY CCS</option> -->
                        </select>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-1">
                            <input type='submit' value='Download' class="btn btn-success" onclick="f1.action='excel-form-ccs.php';  return true;">
                        </div>
                    </div>                   
                </div>
            </form>
            ...
            $sql = "SELECT count(id) as rowtot from msschedule WHERE class LIKE '$class'";
            ...
            $sql = "select * FROM msschedule WHERE class LIKE '$class'";
