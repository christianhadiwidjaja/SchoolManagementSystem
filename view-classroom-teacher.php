...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(isset($_POST['searchbyname'])){
        ...
        //echo "<script type='text/javascript'>alert('$testes');window.location.href='view-classroom-teacher.php';</script>";
        header("location: view-classroom-teacher.php");
        return;
    }
    ...
    if(isset($_POST['takejob'])){;
	    ...
	    if ($conn->query($sql) === TRUE) {
		echo "<script type='text/javascript'>alert('Form Taken!');window.location.href='view-classroom-teacher.php';</script>";
	    }            
        }
    }
    ...
    if(isset($_POST['uploaddok'])){
        if (($_FILES['filedocument']['name']!="")){
            ...
            if (file_exists($path_filename_ext)) {
                echo "<script type='text/javascript'>alert('Sudah ada file dengan identitas yang sama! Tolong re-name file!');window.location.href='view-classroom-teacher.php';</script>";
            }
            else{
                move_uploaded_file($temp_name,$path_filename_ext);
                echo "<script type='text/javascript'>alert('Document Uploaded! $path_filename_ext');window.location.href='view-classroom-teacher.php';</script>";
            }
    ...
    if(isset($_POST['deletedocument'])){
        ...
        echo "<script type='text/javascript'>alert('Document deleted! $doclink');window.location.href='view-classroom-teacher.php';</script>";
    }
    ...
    if(isset($_POST['editpicform'])){
        ...
        if ($conn->query($sql) === TRUE) {
            echo "<script type='text/javascript'>alert('PIC telah diedit!');window.location.href='view-classroom-teacher.php';</script>";
        }
    }
}
