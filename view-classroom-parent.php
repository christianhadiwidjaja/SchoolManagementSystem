...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(isset($_POST['searchbyname'])){
        ...
        header("location: view-classroom-parent.php");
        return;
    }
    ...
    if(isset($_POST['takeattendance'])){
        ...
        if ($conn->query($sql) === TRUE) {
            echo "<script type='text/javascript'>alert('Attendance Taken! $student_id');window.location.href='view-classroom-parent.php';</script>";
        }
    }
    ...
    if(isset($_POST['uploaddok'])){
        ...
        if (($_FILES['filedocument']['name']!="")){
            ...
            if (file_exists($path_filename_ext)) {
                echo "<script type='text/javascript'>alert('Sudah ada file dengan identitas yang sama! Tolong re-name file!');window.location.href='my-form-ccs.php';</script>";
            }
            else{
                ...
                if (stristr($contents, "/Encrypt")) {
                    echo "<script type='text/javascript'>alert('Tidak boleh upload file yang dipassword!');window.location.href='my-form-ccs.php';</script>";
                    unlink($path_filename_ext);
                }

                else if($conn->query($sql) === TRUE) {
                    echo "<script type='text/javascript'>alert('Updated1!');window.location.href='my-form-ccs.php';</script>";
                }

                // echo "<script type='text/javascript'>alert('Updated!');window.location.href='my-form-ccs.php';</script>";
                echo "<script type='text/javascript'>alert('Document Uploaded! $path_filename_ext');window.location.href='my-form-ccs.php';</script>";
            }
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            ?>
            <h1>View All Class (<?php echo $stuname;?>)</h1>
            <hr>
                ...
                <table class="table table-hover" style="width:100%;">
                    <thead>
                        <tr>
                            ...
                            <th class="col-md-1" style="width:5%;">Teacher</th>
