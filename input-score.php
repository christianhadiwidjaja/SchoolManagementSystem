...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(isset($_POST['searchbyname'])){
        ...
        header("location: input-score.php");
        return;
    }
    ...
    if(isset($_POST['updatescore'])){;
        $getCurrID = $_POST['idd'];
        $assignment_score = $_POST['assignmentscore'];
        $uas_score = $_POST['uasscore'];
        $uts_score = $_POST['utsscore'];
        $project_score = $_POST['projectscore'];
        $idd = $_SESSION['id'];

        $conn = new mysqli("localhost","root","","kckrctb");
			
		$sql = "UPDATE `msscore` SET assignment_score = '$assignment_score', uts_score = '$uts_score', uas_score = '$uas_score', project_score = '$project_score'
                WHERE id LIKE '$getCurrID'";
   
        if ($conn->query($sql) === TRUE) {
		    echo "<script type='text/javascript'>alert('Scores Updated!');window.location.href='input-score.php';</script>";           
        }
    }
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="filtersubject" class="form-select">
                            ...
                            $sql= "select * FROM msteacher where user_id LIKE '$idd'";
                            $teacher_idd = "";
                            ...
                            $sql123 = "SELECT * FROM msschedule WHERE teacher_id LIKE '$teacher_idd' GROUP BY subject_name";
                            $result123 = $conn->query($sql123);
                            if ($result123->num_rows > 0) {
                                while($row123 = $result123->fetch_assoc()) {
                                    ?>
                                        <option value="<?php echo $row123['subject_id']; ?>" <?php if($_SESSION['filtersubjectsess'] == $row123['subject_id']){ echo "selected";} ?>><?php echo $row123['subject_name']; ?></option>
                                    <?php
                                }
                            }
                            ?>
            ...
            $sql = "SELECT count(a.id) as rowtot FROM `msscore` a 
            LEFT JOIN mssubject b ON a.subject_id = b.id
            LEFT JOIN msstudent c ON a.student_id = c.id

            WHERE a.student_id LIKE '%".$student_id."%' AND a.subject_id LIKE '$subjectfilter'";
            ...
            $sql= "select * FROM mssubject where id LIKE '$subjectfilter'";
            $classtemp = "";
            ...
            $sql = "SELECT a.name AS name, a.id AS id, a.class AS class, b.id AS msscore_id, b.assignment_score AS assignment_score, 
                    b.uts_score AS uts_score, b.uas_score AS uas_score, b.project_score AS project_score, 
                    (b.assignment_score + b.uts_score + b.project_score + b.uas_score)/4 AS average_score
                    FROM msstudent a 
                    LEFT JOIN msscore b ON a.id = b.student_id
                    WHERE a.class LIKE '$classtemp' AND b.subject_id LIKE '$subjectfilter' AND b.uts_score IS NOT NULL";
                ...
                <table class="table table-hover" style="width:100%;">
                    <thead>
                        <tr>
                            ...
                            <th class="col-md-2" style="width:10%;">Name</th>
                            <th class="col-md-1" style="width:10%;">Assignment</th>
                            <th class="col-md-1" style="width:9%;">UTS</th>
                            <th class="col-md-1" style="width:9%;">UAS</th>
                            <th class="col-md-1" style="width:9%;">Project</th>
                            <th class="col-md-1" style="width:9%;">Average Score</th>
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        <tr style="text-align: left;">
                            ...
                            <td style="vertical-align:middle;"><?php echo $student_name;?></td>   
                            <td style="vertical-align:middle;"><?php echo $assignment_score;?></td>
                            <td style="vertical-align:middle;"><?php echo $uts_score;?></td>
                            <td style="vertical-align:middle;"><?php echo $uas_score;?></td>
                            <td style="vertical-align:middle;"><?php echo $project_score;?></td>
                            <td style="vertical-align:middle;"><?php echo $average_score;?></td>
                            <td style="vertical-align:middle;">
                                <a type="button" data-bs-toggle="modal" class="btn btn-primary" data-bs-target="#b">Edit Details</h2></a>
                            </td>
                                ...
                                <div class="modal-dialog" style="max-width:465px;">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title"><strong><?php echo $student_name;?>'s Score</strong></h4>
                                        ...
                                        <div class="modal-body">
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <input  class="form-control" style="width:420px;" value ="<?php echo $assignment_score;?>" name="assignmentscore" required>
                                                <br>

                                                <label>UTS Score:</label>
                                                <input  class="form-control" name="utsscore" value ="<?php echo $uts_score;?>" style="width:420px" required>
                                                <br>

                                                <label>UAS Score:</label>
                                                <input  class="form-control" name="uasscore" style="width:420px" value ="<?php echo $uas_score;?>" required>
                                                <br>

                                                <label>Project Score:</label>
                                                <input  class="form-control" name="projectscore" value ="<?php echo $project_score;?>" style="width:420px" required>
                                                <br>

                                                <label>Average Score:</label>
                                                <input  class="form-control" name="averagescore" value ="<?php echo $average_score;?>" style="width:420px" disabled>
                                                <br>
                                                ...
                                                <button class="btn btn-primary" onclick="return confirm('update scores?');" name="updatescore">Update</button>
